            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group d-flex flex-column">
                        <br><label for="username" class="font-weight-bold">Username:</label>
                        <input type="text" readonly class="form-control" id="username" value="<?php echo $user['name']; ?>">
                    </div>
                    <div class="form-group d-flex flex-column">
                    <br><label for="total_doctors" class="font-weight-bold">Total Registered Doctor</label>
